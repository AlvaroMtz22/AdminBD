...
namespace Bundler
{
    class Program
    {
       ...
       // C: \Users\docencia\source\repos\AdminBD\ConsoleDatabase\bin\Release\net5.0
            ...
            string rootFolderInZip = "AdminBD/"; //name of the folder created inside the zip file

            files.Add(mainExe);
            files.Add(dbManagerDll);

            string outputFile = relPathToSolutionRootFolder + "AdminBD-" + version + ".zip"; //name of the output zip file
